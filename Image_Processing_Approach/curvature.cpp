...
/*
cout<<"***************"<<"\n";
cout<<"temp2"<<temp2.size()<<"\n";
cout<<"X_t"<<X_t.size()<<"\n";
cout<<"temp3"<<temp3.size()<<"\n";
cout<<"src_y"<<src_y.size()<<"\n";
cout<<"***************"<<"\n";
*/
dst = W.clone();
...
int main(int argc, char* argv[])
{
     ...
     VideoCapture cap("Image_Processing_Approach/test4.mp4"); // open the default camera
   ...
   while (true)
     {
         ...
         // undistort(input, input, intrinsic, distCoeffs);
      ...
      */    // Apply the Perspective Transform just found to the src image
          ...
          //change type
          //histogram.convertTo(histogram,CV_32FC3);
